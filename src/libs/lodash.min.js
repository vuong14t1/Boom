...
_.insertArray = function(array, index, obj){
    if(index >= array.length) array.push(obj)
    else array.splice(index, 0, obj);
};

_.appendArray = function(source, other){
    if(source == null || other == null) return;
    for(var i = 0; i < other.length; ++i){
        source[source.length] = other[i];
    }
};